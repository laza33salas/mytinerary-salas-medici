...
const CitiesCards = () => {
  const dataCiudad = [
    {
      photo: "https://images.pexels.com/photos/3132304/pexels-photo-3132304.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", city: "Hong Kong", country: "China",
    ...
    {
      photo: "https://images.pexels.com/photos/2607918/pexels-photo-2607918.jpeg?auto=compress&cs=tinysrgb&w=1600", city: "Bangkok", country: "Thailand",
      descripcion: 'Bangkok means "village of the wild plum" and is the city of a part of the Thon Buri river side. Thus, Bangkok is known as Krung Thep Mahanakhon. It was a small trading post at the mouth of the Chao Phraya River during the Ayutthaya kingdom.'
    },
    {
      photo: "https://images.pexels.com/photos/777059/pexels-photo-777059.jpeg?auto=compress&cs=tinysrgb&w=1600", city: "Singapore", country: "Singapore",
    ...
    {
      photo: "https://images.pexels.com/photos/672532/pexels-photo-672532.jpeg?auto=compress&cs=tinysrgb&w=1600", city: "London", country: "England",
    ...
    {
      photo: "https://images.pexels.com/photos/3182530/pexels-photo-3182530.jpeg?auto=compress&cs=tinysrgb&w=1600", city: "Paris", country: "France",
    ...
    {
      photo: "https://images.pexels.com/photos/7062250/pexels-photo-7062250.jpeg?auto=compress&cs=tinysrgb&w=1600", city: "Macau", country: "China",
    ...
    {
      photo: "https://images.pexels.com/photos/2404843/pexels-photo-2404843.jpeg?auto=compress&cs=tinysrgb&w=1600", city: "New York", country: "EEUU",
    ...
    {
      photo: "https://images.pexels.com/photos/6640207/pexels-photo-6640207.jpeg?auto=compress&cs=tinysrgb&w=1600", city: "Rome", country: "Italy",
    ...
    {
      photo: "https://images.pexels.com/photos/9577175/pexels-photo-9577175.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", city: "Kuala Lumpur", country: "Malaysia",
    ...
    {
      photo: "https://images.pexels.com/photos/13059585/pexels-photo-13059585.jpeg?auto=compress&cs=tinysrgb&w=1600", city: "Antalya", country: "Turkey",
      descripcion: "Antalya (formerly known as Adalia, from the Greek pamphylian: Αττάλεια Attália) is a city located on the Mediterranean coast of southwestern Turkey. It is the capital of the province of Antalya and gives its city to one of the largest gulfs on the Turkish coast, the Gulf of Antalya."
    },
    {
      photo: "https://images.pexels.com/photos/11077078/pexels-photo-11077078.jpeg?auto=compress&cs=tinysrgb&w=1600", city: "Istanbul", country: "Turkey",
    ...
    {
      photo: "https://images.pexels.com/photos/3727262/pexels-photo-3727262.jpeg?auto=compress&cs=tinysrgb&w=1600", city: "Dubai", country: "United Arab Emirates",
  ...
  const cards = (item) => (
    ...
    <div className="card">
      ...
      <div className='face back'>
        ...
        <div className='link'>
          <LinkRouter className='card-a-front' to={"/Cities/" + item.city}>Details</LinkRouter>
        </div>
      </div>
